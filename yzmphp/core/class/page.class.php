...
class page{
	...
	public function gethome(){	
		return '<li class="page-item"><a href="'.$this->make_url(1).'" class="page-link">'.L('home_page').'</a></li>';
	}
	...
	public function getend(){	
		return '<li class="page-item"><a href="'.$this->make_url($this->total_page).'" class="page-link">'.L('end_page').'</a></li>';
	}
	...
	public function getpre(){
		if($this->now_page<=1){
			return '<li class="page-item"><a href="'.$this->make_url(1).'" class="page-link">'.L('pre_page').'</a></li>';
		}
		return '<li class="page-item"><a href="'.$this->make_url($this->now_page-1).'" class="page-link">'.L('pre_page').'</a></li>';
	}
	...
	public function getnext(){
		if($this->now_page>=$this->total_page){
			return '<li class="page-item"><a href="'.$this->make_url($this->now_page).'" class="page-link">'.L('next_page').'</a></li>';
		}
		return '<li class="page-item"><a href="'.$this->make_url($this->now_page+1).'" class="page-link">'.L('next_page').'</a></li>';
	}
	...
	public function getlist(){
		...
		if($this->total_page<=5){
			for($i=1; $i<=$this->total_page; $i++){
				$class = $this->now_page==$i ? ' active' : '';
				$str.='<li class="page-item '.$class.'"><a href="'.$this->make_url($i).'" class="page-link">'.$i.'</a></li>';
			}
		}else{	
			if($this->now_page <= 3){
				$p =5;
	...
	public function getfull(){
	    ...
	    return ($this->getpre()).($this->getlist()).($this->getnext());
	}
